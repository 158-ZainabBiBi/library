(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['ngx-icon-picker'] = {}, global.ng.core, global.ng.common));
    ...
    var BootstrapIconsPack = /** @class */ (function () {
        function BootstrapIconsPack() {
        }
        BootstrapIconsPack.prototype.getIcons = function () {
            return [
                {
                    id: 'asterisk',
                    name: 'Asterisk'
        ...
        return BootstrapIconsPack;
    }());

    var FontAwesome4IconsPack = /** @class */ (function () {
        function FontAwesome4IconsPack() {
        }
        FontAwesome4IconsPack.prototype.getIcons = function () {
            return [
                {
                    name: 'Glass',
                    id: 'glass',
        ...
        return FontAwesome4IconsPack;
    }());

    var FontAwesome5IconsPack = /** @class */ (function () {
        function FontAwesome5IconsPack() {
        }
        FontAwesome5IconsPack.prototype.getIcons = function () {
            return [
                {
                    id: 'fab fa-500px',
                    name: '500px',
        ...
        return FontAwesome5IconsPack;
    }());

    var MaterialIconsPack = /** @class */ (function () {
        function MaterialIconsPack() {
        }
        MaterialIconsPack.prototype.getIcons = function () {
            return [
                {
                    name: '3D Rotation',
                    id: '3d_rotation',
            ...
            ipIconPacks.forEach(function (ipIconPack) {
                if (ipIconPack === 'fa' || ipIconPack === 'all') {
                    var faIcons = _this.fa4IconsPack.getIcons().map(function (icon) {
                        icon.type = exports.IconType.FontAwesome;
                        return icon;
                    });
                ...
                if (ipIconPack === 'fa5' || ipIconPack === 'all') {
                    var fa5Icons = _this.fa5IconsPack.getIcons().map(function (icon) {
                        icon.type = exports.IconType.FontAwesome5;
                        return icon;
                    });
                ...
                if (ipIconPack === 'mat' || ipIconPack === 'all') {
                    var matIcons = _this.matIconsPack.getIcons().map(function (icon) {
                        icon.type = exports.IconType.Material;
                        return icon;
                    });
    ...
    var IconPickerComponent = /** @class */ (function () {
        ...
        IconPickerComponent.prototype.selectIcon = function (icon) {
            if (icon.type === exports.IconType.FontAwesome) {
            ...
            else if (icon.type === exports.IconType.FontAwesome5) {
                this.directiveInstance.iconSelected("" + icon.id);
            }
            else if (icon.type === exports.IconType.Material) {
                this.directiveInstance.iconSelected("" + icon.id);
            }
    ...
    IconPickerDirective.propDecorators = {
        iconPicker: [{ type: core.Input }],
        ipPlaceHolder: [{ type: core.Input }],
        ipPosition: [{ type: core.Input }],
        ipFallbackIcon: [{ type: core.Input }],
        ipHeight: [{ type: core.Input }],
        ipMaxHeight: [{ type: core.Input }],
        ipWidth: [{ type: core.Input }],
        ipIconSize: [{ type: core.Input }],
        ipIconVerticalPadding: [{ type: core.Input }],
        ipIconHorizontalPadding: [{ type: core.Input }],
        ipIconPack: [{ type: core.Input }],
        ipKeepSearchFilter: [{ type: core.Input }],
        ipButtonStyleClass: [{ type: core.Input }],
        ipDivSearchStyleClass: [{ type: core.Input }],
        ipInputSearchStyleClass: [{ type: core.Input }],
        iconPickerSelect: [{ type: core.Output }]
    };
