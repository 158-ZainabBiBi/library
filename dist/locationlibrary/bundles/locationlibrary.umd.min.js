...
/*! *****************************************************************************
    ...
    ***************************************************************************** */
var L=function(t,e){return L=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,e){t.__proto__=e}||function(t,e){for(var o in e)Object.prototype.hasOwnProperty.call(e,o)&&(t[o]=e[o])},L(t,e)};Object.create;Object.create;var C=function(t){function e(){var e=t.call(this)||this;return e.headers.set("Content-Type","application/json"),e.headers.set("grant_type","password"),e}return function(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Class extends value "+String(e)+" is not a constructor or null");function o(){this.constructor=t}L(t,e),t.prototype=null===e?Object.create(e):(o.prototype=e.prototype,new o)}(e,t),e.prototype.merge=function(e){var o=t.prototype.merge.call(this,e);if(e.url){if(-1!==e.url.search("/USERLOGIN/"))var n=JSON.parse(localStorage.getItem(_)).basic_Token_;else n=JSON.parse(localStorage.getItem(_)).access_token;return o.headers.set("authorization","bearer "+n),o}return o.headers.set("authorization","bearer "+JSON.parse(localStorage.getItem(_)).access_token),o},e}(l.BaseRequestOptions),P=function(){function t(t,e){this.http=t,this.loginService=e,this.LoggedUserId=this.loginService.loaddetail(),this.BaseUrl=this.loginService.loaddetail().oauthservice_PATH}return t.prototype.userprivileges=function(){return this.http.post(this.BaseUrl+"login/userprivileges",{application_ID:this.loginService.loaddetail().application_ID},{headers:new l.Headers({"Content-Type":"application/json",grant_type:"password",authorization:"bearer "+this.loginService.loaddetail().basic_Token_})}).pipe(a.map((function(t){return t.json()})))},t}();P.ɵprov=p.ɵɵdefineInjectable({factory:function(){return new P(p.ɵɵinject(v.Http),p.ɵɵinject(m))},token:P,providedIn:"root"}),P.decorators=[{type:e.Injectable,args:[{providedIn:"root"}]}],P.ctorParameters=function(){return[{type:l.Http},{type:m}]},t.GetaddressService=T,t.HttpErrorInterceptor=q,t.HttpcallService=I,t.LocationComponent=S,t.LocationService=D,t.LocationleveltypeComponent=w,t.LocationleveltypeService=b,t.LocationlibraryComponent=f,t.LocationlibraryModule=A,t.LocationlibraryService=y,t.LocationsearchfilterComponent=E,t.LoginService=m,t.LookupService=N,t.OnfailService=O,t.RequestOptionsService=C,t.SidebarService=P,Object.defineProperty(t,"__esModule",{value:!0})}));
